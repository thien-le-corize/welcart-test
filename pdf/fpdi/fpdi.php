...
if (class_exists('TCPDF', false)) {
    require_once( USCES_PLUGIN_DIR . '/pdf/fpdi/fpdi2tcpdf_bridge.php');
}

require_once( USCES_PLUGIN_DIR . '/pdf/fpdi/fpdf_tpl.php');
require_once( USCES_PLUGIN_DIR . '/pdf/fpdi/fpdi_pdf_parser.php');
